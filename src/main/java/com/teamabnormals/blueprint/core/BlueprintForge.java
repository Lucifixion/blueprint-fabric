...
@EventBusSubscriber(modid = BlueprintForge.MOD_ID, bus = EventBusSubscriber.Bus.MOD)
...
//		bus.addListener(BlueprintDataPackRegistries::registerRegistries);
	...
	private void dataSetup(GatherDataEvent event) {
		...
		generator.addProvider(includeServer, new BlueprintPoiTypeTagsProvider(packOutput, lookupProvider, fileHelper));
	...
	private void postLoadingSetup(FMLLoadCompleteEvent event) {
		event.enqueueWork(() -> {
			...
			Cat.TEMPT_INGREDIENT = Ingredient.of(Cat.TEMPT_INGREDIENT, Ingredient.of(BlueprintItemTags.CAT_FOOD));
